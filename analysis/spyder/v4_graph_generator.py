...
rov_color  =  'C5'
peer_color = 'C8'
five_color  =  peer_color
ten_color  =  peer_color
twenty_color  =  peer_color
forty_color = peer_color
fifty_color = peer_color
hundred_color = peer_color
...
linemap = {
    ...
    'BGPIm Cloudflare - adopting': {'color': cloudflare_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - adopting': {'color': cloudflare_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=2 adopting': {'color': cloudflare_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=5 adopting': {'color': cloudflare_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=10 adopting': {'color': cloudflare_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    ...
    'BGPIm Peer 5 - adopting': {'color': five_color, 'marker': square_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 5 - adopting': {'color': five_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=2 adopting': {'color': five_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=5 adopting': {'color': five_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=10 adopting': {'color': five_color, 'marker': square_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 10 - adopting': {'color': ten_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - adopting': {'color': ten_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=2 adopting': {'color': ten_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=5 adopting': {'color': ten_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=10 adopting': {'color': ten_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    
    'BGPIm Peer 20 - adopting': {'color': twenty_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - adopting': {'color': twenty_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=2 adopting': {'color': twenty_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=5 adopting': {'color': twenty_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=10 adopting': {'color': twenty_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 40 - adopting': {'color': peer_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - adopting': {'color': peer_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=2 adopting': {'color': peer_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=5 adopting': {'color': peer_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=10 adopting': {'color': peer_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Peer 50 - adopting': {'color': fifty_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - adopting': {'color': fifty_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=2 adopting': {'color': fifty_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=5 adopting': {'color': fifty_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=10 adopting': {'color': fifty_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Peer 100 - adopting': {'color': hundred_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - adopting': {'color': hundred_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=2 adopting': {'color': hundred_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=5 adopting': {'color': hundred_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=10 adopting': {'color': hundred_color, 'marker': horizontal_line, 'linestyle': dotted_style},   
...
compare_policies_linemap = {
    ...
    'BGPIm Cloudflare - adopting': {'color': bgpim_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - adopting': {'color': bgpim_ms_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=2 adopting': {'color': bgpim_ms_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=5 adopting': {'color': bgpim_ms_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=10 adopting': {'color': bgpim_ms_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    ...
    'BGPIm Peer 5 - adopting': {'color': bgpim_color, 'marker': square_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 5 - adopting': {'color': bgpim_ms_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=2 adopting': {'color': bgpim_ms_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=5 adopting': {'color': bgpim_ms_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=10 adopting': {'color': bgpim_ms_color, 'marker': square_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 10 - adopting': {'color': bgpim_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - adopting': {'color': bgpim_ms_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=2 adopting': {'color': bgpim_ms_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=5 adopting': {'color': bgpim_ms_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=10 adopting': {'color': bgpim_ms_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    
    'BGPIm Peer 20 - adopting': {'color': bgpim_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - adopting': {'color': bgpim_ms_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=2 adopting': {'color': bgpim_ms_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=5 adopting': {'color': bgpim_ms_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=10 adopting': {'color': bgpim_ms_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 40 - adopting': {'color': bgpim_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=2 adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=5 adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=10 adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Peer 50 - adopting': {'color': bgpim_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=2 adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=5 adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=10 adopting': {'color': bgpim_ms_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Peer 100 - adopting': {'color': bgpim_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - adopting': {'color': bgpim_ms_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=2 adopting': {'color': bgpim_ms_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=5 adopting': {'color': bgpim_ms_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=10 adopting': {'color': bgpim_ms_color, 'marker': horizontal_line, 'linestyle': dotted_style},   
...
compare_policies_by_attack_relay_linemap = {
    ...
    'BGPIm Cloudflare - adopting': {'color': not_attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - adopting': {'color': not_attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=2 adopting': {'color': not_attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=5 adopting': {'color': not_attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Cloudflare - k=10 adopting': {'color': not_attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    ...
    'BGPIm Peer 5 - adopting': {'color': not_attacked_color, 'marker': square_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 5 - adopting': {'color': not_attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=2 adopting': {'color': not_attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=5 adopting': {'color': not_attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=10 adopting': {'color': not_attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 10 - adopting': {'color': not_attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - adopting': {'color': not_attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=2 adopting': {'color': not_attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=5 adopting': {'color': not_attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=10 adopting': {'color': not_attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    
    'BGPIm Peer 20 - adopting': {'color': not_attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - adopting': {'color': not_attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=2 adopting': {'color': not_attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=5 adopting': {'color': not_attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=10 adopting': {'color': not_attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 40 - adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=2 adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=5 adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=10 adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Peer 50 - adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=2 adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=5 adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=10 adopting': {'color': not_attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Peer 100 - adopting': {'color': not_attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - adopting': {'color': not_attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=2 adopting': {'color': not_attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=5 adopting': {'color': not_attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=10 adopting': {'color': not_attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    ...
    'BGPIm Attacked Cloudflare - adopting': {'color': attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Attacked Cloudflare - adopting': {'color': attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Attacked Cloudflare - k=2 adopting': {'color': attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Attacked Cloudflare - k=5 adopting': {'color': attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    'BGPImMS Attacked Cloudflare - k=10 adopting': {'color': attacked_color, 'marker': star_marker, 'linestyle': cloudflare_style},
    ...
    'BGPIm Attacked Peer 5 - adopting': {'color': attacked_color, 'marker': square_marker, 'linestyle': dotted_style},    
    'BGPImMS Attacked Peer 5 - adopting': {'color': attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 5 - k=2 adopting': {'color': attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 5 - k=5 adopting': {'color': attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 5 - k=10 adopting': {'color': attacked_color, 'marker': square_marker, 'linestyle': dotted_style},
    
    'BGPIm Attacked Peer 10 - adopting': {'color': attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 10 - adopting': {'color': attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 10 - k=2 adopting': {'color': attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 10 - k=5 adopting': {'color': attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 10 - k=10 adopting': {'color': attacked_color, 'marker': thin_diamond, 'linestyle': dotted_style},
    
    'BGPIm Attacked Peer 20 - adopting': {'color': attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 20 - adopting': {'color': attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 20 - k=2 adopting': {'color': attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 20 - k=5 adopting': {'color': attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 20 - k=10 adopting': {'color': attacked_color, 'marker': triangle_marker, 'linestyle': dotted_style},
    
    'BGPIm Attacked Peer 40 - adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 40 - adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 40 - k=2 adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 40 - k=5 adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 40 - k=10 adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Attacked Peer 50 - adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 50 - adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 50 - k=2 adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 50 - k=5 adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 50 - k=10 adopting': {'color': attacked_color, 'marker': vertical_line, 'linestyle': dotted_style},   
    
    'BGPIm Attacked Peer 100 - adopting': {'color': attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 100 - adopting': {'color': attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 100 - k=2 adopting': {'color': attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 100 - k=5 adopting': {'color': attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
    'BGPImMS Attacked Peer 100 - k=10 adopting': {'color': attacked_color, 'marker': horizontal_line, 'linestyle': dotted_style},
...
linemap_2 = {
    ...
    'BGPImMS Peer 5 - k=2 adopting': {'color': 'C0', 'marker': pentagon_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=5 adopting': {'color': 'C1', 'marker': pentagon_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=10 adopting': {'color': 'C2', 'marker': pentagon_marker, 'linestyle': dotted_style},
...
compare_relays_linemap = {
    ...
    'BGPIm Peer 5 - adopting': {'color': 'C5', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 5 - adopting': {'color': 'C5', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 5 - k=2 adopting': {'color': 'C5', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=5 adopting': {'color': 'C5', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 5 - k=10 adopting': {'color': 'C5', 'marker': default_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 10 - adopting': {'color': 'C6', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - adopting': {'color': 'C6', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=2 adopting': {'color': 'C6', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=5 adopting': {'color': 'C6', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 10 - k=10 adopting': {'color': 'C6', 'marker': default_marker, 'linestyle': dotted_style},

    'BGPIm Peer 20 - adopting': {'color': 'C7', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 20 - adopting': {'color': 'C7', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 20 - k=2 adopting': {'color': 'C7', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=5 adopting': {'color': 'C7', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 20 - k=10 adopting': {'color': 'C7', 'marker': default_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 40 - adopting': {'color': 'C8', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 40 - adopting': {'color': 'C8', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 40 - k=2 adopting': {'color': 'C8', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=5 adopting': {'color': 'C8', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 40 - k=10 adopting': {'color': 'C8', 'marker': default_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 50 - adopting': {'color': 'C9', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 50 - adopting': {'color': 'C9', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 50 - k=2 adopting': {'color': 'C9', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=5 adopting': {'color': 'C9', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 50 - k=10 adopting': {'color': 'C9', 'marker': default_marker, 'linestyle': dotted_style},
    
    'BGPIm Peer 100 - adopting': {'color': 'C0', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 100 - adopting': {'color': 'C0', 'marker': default_marker, 'linestyle': dotted_style},    
    'BGPImMS Peer 100 - k=2 adopting': {'color': 'C0', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=5 adopting': {'color': 'C0', 'marker': default_marker, 'linestyle': dotted_style},
    'BGPImMS Peer 100 - k=10 adopting': {'color': 'C0', 'marker': default_marker, 'linestyle': dotted_style},
}
