...
#SBATCH --ntasks=160                            # Request Number of CPU cores
...
#python ../../python_scripts/artemis_main.py akamai 1
#python ../../python_scripts/artemis_main.py akamai 2
python ../../python_scripts/artemis_main.py akamai 5
