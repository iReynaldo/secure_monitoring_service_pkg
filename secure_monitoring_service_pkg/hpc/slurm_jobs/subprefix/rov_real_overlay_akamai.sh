...
python ../../../__main__.py --relay_asns akamai --num_trials 500 --cpus 20 --python_hash_seed $PYTHONHASHSEED --rov_adoption real --num_attackers 5 --scenario V4SubprefixHijackScenario
