...
#python __main__.py --percentages 0.01 0.05 0.1 0.2 --relay_asns cloudflare --num_trials 20 --policy v4k5 --cpus 1 --python_hash_seed $PYTHONHASHSEED --rov_adoption none --num_attackers 5 --scenario V4SubprefixHijackScenario
...
#python __main__.py --num_trials 2 --policy rovppo --cpus 2 --python_hash_seed $PYTHONHASHSEED --rov_adoption none --num_attackers 1 --scenario V4SubprefixHijackScenario --collect_agg_as_metadata True

#python __main__.py --num_trials 2 --policy rovppo v4 --relay_asns akamai --cpus 2 --python_hash_seed $PYTHONHASHSEED --rov_adoption none --num_attackers 1 --scenario V4SubprefixHijackScenario --tunnel_customers_traffic --collect_agg_as_metadata
