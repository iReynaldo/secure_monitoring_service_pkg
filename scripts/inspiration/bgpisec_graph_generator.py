...
linemap = {
    ...
    "BGPsec": {
        "color": bgpsec_color,
        "marker": aggressive_marker,
        "linestyle": bgpsec_style,
    },
    "BGPsec+100% ROV": {
        "color": bgpsec_color,
        "marker": aggressive_marker,
    ...
    "Path End, 2-hop": {
        ...
        "marker": aggressive_marker,
        "linestyle": path_end_style,
    },
    "BGP-iSec-Trans-DO only": {
        "color": "C4",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec-Trans-DO only, Aggressive": {
        "color": "C4",
        "marker": aggressive_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec-Trans-DO only, Timid": {
        "color": "C4",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec-Trans-DO only, Connector": {
        "color": "C4",
        "marker": "",
        "linestyle": "dotted",
    },
    "BGP-iSec+100% ROV, Aggressive": {
        "color": bgpisec_color,
        "marker": aggressive_marker,
        "linestyle": default_style,
    },
    "BGP-iSec+100% ROV, Timid": {
        "color": bgpisec_color,
        "marker": timid_marker,
        "linestyle": default_style,
    },
    "BGP-iSec+100% ROV, Timid-Path": {
        "color": bgpisec_color,
        "marker": timid_marker,
        "linestyle": default_style,
    },
    "BGP-iSec+100% ROV, Connector": {
        "color": bgpisec_color,
        "marker": "",
        "linestyle": default_style,
    },
    ...
    "BGP-iSec No Encrypted UP, Timid-Path No Eavesdropping": {
        "color": "C7",
        "marker": timid_marker,
        "linestyle": "dashed",
    },
    "BGP-iSec No Encrypted UP, Timid-Path Eavesdropper": {
        "color": "C8",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec Encrypted UP, Timid-Path Eavesdropper": {
        "color": bgpisec_color,
        "marker": timid_marker,
        "linestyle": "solid",
    },
    ...
    "BGP-iSec Trans, Timid-Path": {
        "color": "C8",
        "marker": timid_marker,
        "linestyle": "dashed",
    },
    "BGP-iSec Transitive Only": {
        "color": "C8",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec Transitive Only, Timid": {
        "color": "C8",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec Transitive Only, Aggressive": {
        "color": "C8",
        "marker": aggressive_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec Transitive Only, Connector": {
        "color": "C8",
        "marker": "",
        "linestyle": "dotted",
    },
    ...
    "BGP-iSec Trans-DO, Timid-Path": {
        "color": "C7",
        "marker": timid_marker,
        "linestyle": "dashed",
    },
    "BGP-iSec with Path Shortening Defense": {
        "color": "C7",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec with Path Shortening Defense, Aggressive": {
        "color": "C7",
        "marker": aggressive_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec with Path Shortening Defense, Timid": {
        "color": "C7",
        "marker": timid_marker,
        "linestyle": "dotted",
    },
    "BGP-iSec with Path Shortening Defense, Connector": {
        "color": "C7",
        "marker": "",
        "linestyle": "dotted",
    },
    ...
    "BGP-iSec, Timid Overhead 99% dropping": {
        "color": "C6",
        "marker": overhead_marker,
        "linestyle": "dotted",
    },
        ...
        def parse(subgraph_name: str):
            ...
            for dataset in json_data:
                rates = dataset[subgraph_name][propagation_round][
                    f"{base_policy_name} ({adopting_policy_name} adopting)"
                ]
