...
#     from secure_monitoring_service_pkg.tests.performance_tests.mvdp_benchmark.report_path_lists.path_list_1 import reports_path_list

# with timer("Path List 2") as atimer:
#     from secure_monitoring_service_pkg.tests.performance_tests.mvdp_benchmark.report_path_lists.path_list_2 import reports_path_list
#
# with timer("Path List 3") as atimer:
#     from secure_monitoring_service_pkg.tests.performance_tests.mvdp_benchmark.report_path_lists.path_list_3 import reports_path_list
#
# with timer("Path List 4") as atimer:
#     from secure_monitoring_service_pkg.tests.performance_tests.mvdp_benchmark.report_path_lists.path_list_4 import reports_path_list
#
# with timer("Path List 5") as atimer:
#     from secure_monitoring_service_pkg.tests.performance_tests.mvdp_benchmark.report_path_lists.path_list_5 import reports_path_list
