...
turnover=True
# relay
attack_relay = False  # TODO: Change this to True
num_attackers = 5
num_trials = 4000
    ...
    for adoption_setting in [dm.adopting_setting]:
        for rov_setting in rov_settings:
            for metric in [dm.attacker_success, dm.victim_success, dm.disconnections]:
                ...
                # Load paths
                # Policy 1 path list
                policy_1_1_attacker = [dm.json_file(scenario, scenario_type, 'v4', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, num_attackers, num_trials, tunnel=True)]
                policy_1_5_attacker = [dm.json_file(scenario, scenario_type, 'v4', rov_setting, rov_conf, turnover, hash_seed, probe, 'verisign', attack_relay, num_attackers, num_trials, tunnel=True)]
                policy_1_10_attacker = [dm.json_file(scenario, scenario_type, 'v4', rov_setting, rov_conf, turnover, hash_seed, probe, 'neustar', attack_relay, num_attackers, num_trials, tunnel=True)]
                policy_1_20_attacker = [dm.json_file(scenario, scenario_type, 'v4', rov_setting, rov_conf, turnover, hash_seed, probe, 'akamai', attack_relay, num_attackers, num_trials, tunnel=True)]

                # Policy 2 path list
                policy_2_1_attacker =  [dm.json_file(scenario, scenario_type, 'v4', rov_setting, rov_conf, turnover, hash_seed, probe, 'incapsula', attack_relay, num_attackers, num_trials, tunnel=True)]
                ...
                policy_lines = [(5, 'v4', 'cloudflare'), (5, 'v4', 'verisign'), (5, 'v4', 'neustar'), (5, 'v4', 'akamai'), (5, 'v4', 'incapsula')]
                index = 0
                ...
                generate_plot(lines,
                              ...
                              fname=f"./minerva_plots/others/rov_{rov_conf}/{adoption_setting_str}{scenario_str}_compare_num_attackers_cdns_{dm.metric_filename_prefix[metric]}.pdf")
