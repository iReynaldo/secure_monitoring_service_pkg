    ...
    for adoption_setting in [dm.adopting_setting, dm.all_adoption_setting]:
        for rov_setting in rov_settings:
            for metric in [dm.attacker_success, dm.victim_success, dm.disconnections]:
                ...
                # ROVPPO paths
                # rovppo_paths_1 =  [dm.json_file(scenario, scenario_type, 'others', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, 1, num_trials, tunnel=True)]
                # rovppo_paths_5 =  [dm.json_file(scenario, scenario_type, 'others', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, 5, num_trials, tunnel=True)]
                rovppo_paths_1 =  [dm.json_file(scenario, scenario_type, 'rovppo', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, 1, num_trials, tunnel=True)]
                rovppo_paths_5 =  [dm.json_file(scenario, scenario_type, 'rovppo', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, 5, num_trials, tunnel=True)]
                # ROVO paths
                rovo_paths_1 =  [dm.json_file(scenario, scenario_type, 'rovo', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, 1, num_trials)]
                rovo_paths_5 =  [dm.json_file(scenario, scenario_type, 'rovo', rov_setting, rov_conf, turnover, hash_seed, probe, 'cloudflare', attack_relay, 5, num_trials)]
                ...
                results =  rov_results_5 + rovpp_results_5 + rovppo_results_5
                ...
                policy_lines = [(5, 'rov'), (5, 'rovppv1lite'), (5, 'rovppo')]
                index = 0
                ...
                generate_plot(lines,
                              ...
                              fname=f"./minerva_plots/others/rov_{rov_conf}/{adoption_setting_str[adoption_setting]}{scenario_str}_{dm.metric_filename_prefix[metric]}.pdf")
