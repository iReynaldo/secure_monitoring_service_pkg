            ...
            for rov_setting in rov_settings:
                for metric in [dm.attacker_success, dm.victim_success, dm.disconnections]:
                    ...
                    for attack_relay in (False, True):
                        for relay in relays:
                            scenario_type = 'originHijack' if attack_relay else 'none'
                            paths.append(
                    ...
                    generate_plot(lines,
                                  ...
                                  fname=f"./minerva_plots/attackers_{num_attackers}/rov_{rov_conf}/subprefix_compare_attack_relay_{scenario_type_str}_{dm.metric_filename_prefix[metric]}.pdf")
