...
for i in range(len(relays)):
    if data_table[dm.victim_success][i] and data_table[dm.attacker_success][i] and data_table[dm.disconnections][i]:
        scores.append(data_table[dm.victim_success][i] - (data_table[dm.attacker_success][i] + data_table[dm.disconnections][i]))
    else:
        scores.append(None)
