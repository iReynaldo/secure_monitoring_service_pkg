    ...
    for adoption_setting in [dm.adopting_setting]:
        for rov_setting in rov_settings:
            for metric in [dm.attacker_success, dm.victim_success, dm.disconnections]:
                ...
                results =  policy_1_1_attacker_results + policy_1_20_attacker_results + policy_2_1_attacker_results + policy_2_20_attacker_results
                ...
                # policy_lines = [(1, 'v4', 'cloudflare'), (5, 'v4', 'cloudflare'), (10, 'v4', 'cloudflare'), (20, 'v4', 'cloudflare'), (1, 'v4', 'five'), (5, 'v4', 'five'), (10, 'v4', 'five'), (20, 'v4', 'five'), ]
                policy_lines = [(1, 'v4', 'cloudflare'), (20, 'v4', 'cloudflare'), (1, 'v4', 'five'), (20, 'v4', 'five'), ]
                index = 0
                ...
                generate_plot(lines,
                              ...
                              fname=f"./minerva_plots/others/rov_{rov_conf}/{adoption_setting_str}{scenario_str}_compare_num_attackers_{scenario_type_str}_{dm.metric_filename_prefix[metric]}.pdf")
