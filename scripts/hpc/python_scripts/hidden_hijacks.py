...
# Adopting settings
adoption_settings = {
    "adopters_for_1_attackers": [ROVPPV1LiteSimpleAS, ROVSMS],
...
def other_settings():
    settings = {
        "scenario": AUTOIMMUNE,
        "output_filename": "subprefix_rov_hidden_hijacks_1_attacker",
    }
    return settings
...
def main():
    ...
    experiment_settings_to_save = process_experiment_settings(
        simulation_kwargs(), scenario_kwargs(), other_settings()
    )
