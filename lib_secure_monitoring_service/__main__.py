...
from lib_secure_monitoring_service.rov_sms import ROVSMSK30, ROVSMSK50, ROVSMSK70, ROVSMSK100, ROVSMSK150, ROVSMSK200, ROVSMSK300
...
def main():
    Simulator().run(graphs=[V4Graph(percent_adoptions=[0,5,10,20,40,60,80,100],
                                    adopt_as_classes=[ROVSMSK20, ROVSMSK30, ROVSMSK50, ROVSMSK70, ROVSMSK100, ROVSMSK150, ROVSMSK200, ROVSMSK300],
